package io.github.z1812.hyperdock.compose.theme
...
internal const val PREF_THEME_MODE = PrefKeys.THEME_MODE
internal const val PREF_MONET_ENABLED = PrefKeys.MONET_COLOR_ENABLED
internal const val PREF_THEME_SEED_COLOR = PrefKeys.THEME_SEED_COLOR
internal const val PREF_FLOATING_NAVIGATION_BAR = PrefKeys.FLOATING_NAVIGATION_BAR
internal const val PREF_LIQUID_GLASS_NAVIGATION_BAR = PrefKeys.LIQUID_GLASS_NAVIGATION_BAR
internal const val PREF_BLUR_BARS = PrefKeys.BLUR_BARS
internal const val PREF_PREDICTIVE_BACK_MAX_TRANSLATION = PrefKeys.PREDICTIVE_BACK_MAX_TRANSLATION
