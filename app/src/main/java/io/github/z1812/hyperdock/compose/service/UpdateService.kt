...
internal object UpdateService {
    suspend fun fetchIfNewer(currentVersion: String): AppUpdate? = withContext(Dispatchers.IO) {
        val connection = (URL(LATEST_RELEASE_API).openConnection() as HttpURLConnection).apply {
            ...
            setRequestProperty("User-Agent", "HyperDock/$currentVersion")
        }
        try {
...
private const val LATEST_RELEASE_API =
    "https://api.github.com/repos/1812z/hyperdock/releases/latest"
private const val MODULE_DOWNLOAD_URL =
    "https://github.com/1812z/hyperdock/releases/latest"
